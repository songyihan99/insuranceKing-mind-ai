...
- 첫 문장은 판정된 유형에 맞는 동의 유도 질문으로 시작해라(고객이 Yes라고 할 수밖에 없는 질문):
  ...
  * 규율숭배자: "정확한 보장이 중요하시죠?"
- 고객의 이름, 나이, 직업, 거절 멘트를 정확히 언급해서 "이건 딱 내 얘기다"라고 느끼게 써라.
...
- 섹션3 클로징 이후 섹션4 **설계사 직접 멘트**(fp-ment-box)에서 "이 기회를 놓치지 마세요" 표현 금지. 압박 판매로 느껴질 수 있음.
...
- 섹션3 클로징 이후 섹션4 fp-ment-box에서 "이 기회를 놓치지 마세요" 표현 금지(압박 판매로 느껴질 수 있음).
